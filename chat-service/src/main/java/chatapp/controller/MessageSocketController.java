...
public class MessageSocketController {
    ...
    public void deleteConversation(Map<String, Object> payload) {
        UUID conversationId = (UUID) payload.get("conversationId");
        UUID user1 = (UUID) payload.get("user1Id");
        UUID user2 = (UUID) payload.get("user2Id");
    ...
    public void deleteMessage(Map<String, Object> payload) {
        UUID conversationId = (UUID) payload.get("conversationId");
        UUID messageId = (UUID) payload.get("messageId");
